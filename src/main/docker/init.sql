...
INSERT INTO public.moutmout_user(login, password, last_name, first_name)
...
INSERT INTO public.moutmout_role(name)
VALUES ('ROLE_ADMIN');
...
INSERT INTO public.moutmout_user_role(user_id, role_name)
VALUES (1, 'ROLE_ADMIN');
